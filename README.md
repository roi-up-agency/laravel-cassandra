...
```php
sashalenz\Cassandra\CassandraServiceProvider::class,
```
...
```php
$app->register('sashalenz\Cassandra\CassandraServiceProvider');
...
```php
use sashalenz\Cassandra\Eloquent\Model as Eloquent;
...
```php
'Moloquent'       => 'sashalenz\Cassandra\Eloquent\Model',
```
...
```php
'sashalenz\Cassandra\Auth\PasswordResetServiceProvider',
```
...
```php
use sashalenz\Cassandra\Eloquent\SoftDeletes;
...
If you're using a hybrid Cassandra and SQL setup, you're in luck! The model will automatically return a Cassandra- or SQL-relation based on the type of the related model. Of course, if you want this functionality to work both ways, your SQL-models will need use the `sashalenz\Cassandra\Eloquent\HybridRelations` trait. Note that this functionality only works for hasOne, hasMany and belongsTo relations.

Example SQL-based User model:

```php
use sashalenz\Cassandra\Eloquent\HybridRelations;
