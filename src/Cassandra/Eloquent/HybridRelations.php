...
use RoiupAgency\Cassadra\Relations\BelongsTo;
use RoiupAgency\Cassadra\Relations\BelongsToMany;
use RoiupAgency\Cassadra\Relations\HasMany;
use RoiupAgency\Cassadra\Relations\HasOne;
use RoiupAgency\Cassadra\Relations\MorphTo;
...
trait HybridRelations
{
    ...
    public function hasOne($related, $foreignKey = null, $localKey = null)
    {
        ...
        if (!is_subclass_of($related, 'RoiupAgency\Cassadra\Eloquent\Model')) {
